                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Thêm mới tin tức</h3>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="{{ url()->previous() }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        id="description"
                                                                        name="description"
                                                                        placeholder="Mô tả tin">{{old('description')}}</textarea>
                                                                </div>
                                                            </div>
                                                            @error('description')
                                                            <strong>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        id="detail"
                                                                        name="detail"
                                                                        placeholder="Chi tiết tin">{{old('detail')}}</textarea>
                                                                </div>
                                                            </div>
                                                            @error('detail')
                                                            <strong>
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($division_categories as $division_category)
                                                                        <option value="{{ $division_category->id }}"
                                                                            {{old('news_category_id') == $division_category->id ? 'selected' : ''}}>
