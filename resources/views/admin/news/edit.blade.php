                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Cập nhật tin tức</h3>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="{{ url()->previous() }}"
                                                    ...
                                                    <div class="row col-md-8">
                                                        ...
                                                        <div class="col-12 mb-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="name">Tên tin</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text"
                                                                           class="form-control @error('name') error @enderror"
                                                                           name="name"
                                                                           value="{{old('name') ? old('name') : $news->name}}"
                                                                           id="name"
                                                                           placeholder="Tên tin">
                                                                </div>
                                                                @error('name')
                                                        ...
                                                        <div class="col-12 mb-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="description">Mô tả tin</label>
                                                                <strong
                                                                    class="text-info border border-info rounded-circle"
                                                                    data-toggle="tooltip"
                                                                    data-placement="top"
                                                                    title="Thể hiện tóm tắt tin cho khách hàng dễ quan sát">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        id="description"
                                                                        name="description"
                                                                        placeholder="Mô tả tin">{{old('description') ? old('description') : $news->description}}</textarea>
                                                                </div>
                                                            </div>
                                                            @error('description')
                                                            <strong>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="detail">Chi tiết tin</label>
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        class="form-control @error('detail') error @enderror form-control-sm"
                                                                        id="detail"
                                                                        name="detail"
                                                                        placeholder="Chi tiết tin">{{old('detail') ? old('detail') : $news->detail}}</textarea>
                                                                </div>
                                                            </div>
                                                            @error('detail')
                                                            <strong>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="category">Danh
                                                                    mục</label>
                                                                <select
                                                                    class="form-select @error('news_category_id') error @enderror"
                                                                    name="news_category_id" id="category">
                                                                    @foreach ($division_categories as $division_category)
                                                                        <option value="{{ $division_category->id }}"
                                                                            {{$news->news_category_id == $division_category->id ? 'selected' : ''}}>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text"
                                                                           ...
                                                                           name="meta_keywords"
                                                                           value="{{old('meta_keywords') ? old('meta_keywords') : $news->meta_keywords}}"
                                                                           id="meta-keywords"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        placeholder="Meta description">{{old('meta_description') ? old('meta_description') : $news->meta_description}}</textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input id="thumbnail" class="form-control"
                                                                           ...
                                                                           value="{{ old('thumbnail') ? old('thumbnail') : $news->thumbnail }}">
                                                                </div>
                                                            </div>
                                                            @error('thumbnail')
                                                            <strong>
