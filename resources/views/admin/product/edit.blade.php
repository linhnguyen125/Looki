                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Cập nhật sản phẩm</h3>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="{{ url()->previous() }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        id="description"
                                                                        name="description"
                                                                        placeholder="Mô tả sản phẩm">{{old('description') ? old('description') : $product->description}}</textarea>
                                                                </div>
                                                            </div>
                                                            @error('description')
                                                            <strong>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        id="detail"
                                                                        name="detail"
                                                                        placeholder="Chi tiết sản phẩm">{{old('detail') ? old('detail') : $product->detail}}</textarea>
                                                                </div>
                                                            </div>
                                                            @error('detail')
                                                            <strong>
                                                                ...
                                                                <select data-search="on"
                                                                    ...
                                                                    @foreach ($division_categories as $division_category)
                                                                        <option value="{{ $division_category->id }}"
                                                                            {{$product->category_id == $division_category->id ? 'selected' : ''}}>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        placeholder="Meta description">{{old('meta_description') ? old('meta_description') : $product->meta_description}}</textarea>
                                                                </div>
                                                            </div>
