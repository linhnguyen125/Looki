...
@section('content')
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Danh mục blog</h3>
                                    ...
                                    <div class="nk-tb-col nk-tb-col-tools">
                                        <ul class="nk-tb-actions gx-1">
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{route('admin.category_blog.edit', $category->id)}}"
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{route('admin.category_blog.delete', $category->id)}}"
    ...
    @include('shared.admin.layouts.category_blog.form_create')
@endsection
