...
@section('content')
    ...
    {{--                                                        </div>--}}
    {{--                                                        <div class="user-name">--}}
    {{--                                                            <span class="tb-lead">{{Auth::guard('admin')->user()->name}}</span>--}}
    {{--                                                        </div>--}}
    {{--                                                    </div>--}}
    {{--                                                </div>--}}
    ...
    {{--                                                <div class="nk-tb-col">--}}
    {{--                                                            <span--}}
    {{--                                                                class="badge badge-dot badge-dot-xs badge-success">Paid</span>--}}
    {{--                                                </div>--}}
    {{--                                            </div>--}}
    {{--                                            <div class="nk-tb-item">--}}
    {{--                                                <div class="nk-tb-col">--}}
    ...
    {{--                                                <div class="nk-tb-col">--}}
    {{--                                                            <span--}}
    {{--                                                                class="badge badge-dot badge-dot-xs badge-danger">Canceled</span>--}}
    {{--                                                </div>--}}
    {{--                                            </div>--}}
    {{--                                            <div class="nk-tb-item">--}}
    {{--                                                <div class="nk-tb-col">--}}
    ...
    {{--                                                <div class="nk-tb-col">--}}
    {{--                                                            <span--}}
    {{--                                                                class="badge badge-dot badge-dot-xs badge-warning">Due</span>--}}
    {{--                                                </div>--}}
    {{--                                            </div>--}}
    {{--                                        </div>--}}
    {{--                                    </div><!-- .card -->--}}
    ...
    {{--                                                <li class="item">--}}
    {{--                                                    <div class="thumb">--}}
    {{--                                                        <img src="{{asset('assets/admin/images/product/a.png')}}"--}}
    {{--                                                             alt="">--}}
    {{--                                                    </div>--}}
    {{--                                                    <div class="info">--}}
    ...
    {{--                                                <li class="item">--}}
    {{--                                                    <div class="thumb">--}}
    {{--                                                        <img src="{{asset('assets/admin/images/product/b.png')}}"--}}
    {{--                                                             alt="">--}}
    {{--                                                    </div>--}}
    {{--                                                    <div class="info">--}}
    ...
    {{--                                                <li class="item">--}}
    {{--                                                    <div class="thumb">--}}
    {{--                                                        <img src="{{asset('assets/admin/images/product/c.png')}}"--}}
    {{--                                                             alt="">--}}
    {{--                                                    </div>--}}
    {{--                                                    <div class="info">--}}
    ...
    {{--                                                <li class="item">--}}
    {{--                                                    <div class="thumb">--}}
    {{--                                                        <img src="{{asset('assets/admin/images/product/d.png')}}"--}}
    {{--                                                             alt="">--}}
    {{--                                                    </div>--}}
    {{--                                                    <div class="info">--}}
    ...
    {{--                                                <li class="item">--}}
    {{--                                                    <div class="thumb">--}}
    {{--                                                        <img src="{{asset('assets/admin/images/product/e.png')}}"--}}
    {{--                                                             alt="">--}}
    {{--                                                    </div>--}}
    {{--                                                    <div class="info">--}}
    ...
    {{--                                                            data-placement="left" title="Users of this month"></em>--}}
    {{--                                                    </div>--}}
    {{--                                                </div>--}}
    {{--                                                <div class="data-group">--}}
    {{--                                                    <div class="data">--}}
    ...
    <script>
        ...
        const data = {
            ...
            datasets: [
                {
                    label: 'Thành công',
                    data: [124, 435, 632, 342, 463, 643, 124],
                    borderColor: 'rgba(52, 152, 219,1.0)',
                    backgroundColor: 'rgba(41, 128, 185,1.0)',
                },
                {
                    label: 'Đơn hủy',
                    data: [23, 32, 64, 12, 3, 43, 52],
