                                        ...
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                ...
                                                <div class="nk-block-des">
                                                    <p>Thông tin cơ bản, như tên và địa chỉ của bạn mà bạn sử dụng trên hệ thống.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="nk-data data-list">
                                            ...
                                            <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                                <div class="data-col">
                                                    ...
                                                    <span class="data-value">{{ \Carbon\Carbon::parse($admin->date_of_birth)->format('d M, Y') }}</span>
                                                </div>
                                                <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                                            </div><!-- data-item -->
                                            <div class="data-item" data-toggle="modal" data-target="#profile-edit" data-tab-target="#address">
                                                <div class="data-col">
                                                    ...
                                                    <span class="data-value">{{$admin->address}}</span>
                                                </div>
                                                <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                                            </div><!-- data-item -->
                                        </div><!-- data-list -->
                                    ...
                                    <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="#" data-toggle="modal" data-target="#avatar-edit"><em class="icon ni ni-camera-fill"></em><span>Change Photo</span></a></li>
                                        ...
                                        <div class="card-inner p-0">
                                            <ul class="link-list-menu">
                                                <li><a class="active" href="{{route('admin.user.info', Auth::guard('admin')->id())}}"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li>
