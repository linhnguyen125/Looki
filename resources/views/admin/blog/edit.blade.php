                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Cập nhật blog</h3>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="{{ url()->previous() }}"
                                            ...
                                            <form action="{{route('admin.blog.update', $blog->id)}}"
                                                ...
                                                <div class="row gy-4">
                                                    <div class="row col-md-8">
                                                        ...
                                                        <div class="col-12 mb-2">
                                                            <div class="form-group">
                                                                <label class="form-label" for="description">Mô tả blog</label>
                                                                <strong
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        id="description"
                                                                        name="description"
                                                                        placeholder="Mô tả blog">{{old('description') ? old('description') : $blog->description}}</textarea>
                                                                </div>
                                                            </div>
                                                            @error('description')
                                                            <strong>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        id="detail"
                                                                        name="detail"
                                                                        placeholder="Chi tiết blog">{{old('detail') ? old('detail') : $blog->detail}}</textarea>
                                                                </div>
                                                            </div>
                                                            @error('detail')
                                                            <strong>
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($division_categories as $division_category)
                                                                        <option value="{{ $division_category->id }}"
                                                                            {{$blog->blog_category_id == $division_category->id ? 'selected' : ''}}>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text"
                                                                           ...
                                                                           name="meta_keywords"
                                                                           value="{{old('meta_keywords') ? old('meta_keywords') : $blog->meta_keywords}}"
                                                                           id="meta-keywords"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea
                                                                        ...
                                                                        placeholder="Meta description">{{old('meta_description') ? old('meta_description') : $blog->meta_description}}</textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input id="thumbnail" class="form-control"
                                                                           ...
                                                                           value="{{$blog->thumbnail ?? old('thumbnail')}}">
                                                                </div>
                                                            </div>
                                                            @error('thumbnail')
                                                            <strong>
