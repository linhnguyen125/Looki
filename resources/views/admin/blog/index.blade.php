                                            ...
                                            <li class="nk-block-tools-opt">
                                                ...
                                                <a href="{{route('admin.blog.create')}}"
                                                   class="btn btn-primary d-none d-md-inline-flex"><em
                                                        class="icon ni ni-plus"></em><span>Thêm blog</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="nk-block">
                        <div class="nk-tb-list is-separate mb-3">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col"><span>Tên blog</span></div>
                            ...
                            @foreach($blogs as $blog)
                                <div class="nk-tb-item">
                                    <div class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext">
                                            <input type="checkbox" name="list_check[]" class="custom-control-input" id="{{$blog->id}}">
                                            <label class="custom-control-label" for="{{$blog->id}}"></label>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col">
                                    <span class="tb-product">
                                        <img src="{{$blog->thumbnail}}" alt="" class="thumb">
                                        <span class="title product-name">{{$blog->name}}</span>
                                    </span>
                                    </div>
                                    <div class="nk-tb-col tb-col-sm">
                                        <span class="tb-sub">{{$blog->blog_category->name}}</span>
                                    </div>
                                    ...
                                    <div class="nk-tb-col tb-col-md">
                                        <span class="tb-sub">{{$blog->view}}</span>
                                    </div>
                                    <div class="nk-tb-col nk-tb-col-tools">
                                        <ul class="nk-tb-actions gx-1 my-n1">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="{{route('admin.blog.delete', $blog->id)}}"
                                                   onclick="return confirm('Bạn có chắc chắn xóa blog này khỏi hệ thống? Lưu ý, sau khi xóa sẽ không thể khôi phục!!')"
                                                   class="btn btn-trigger btn-icon" data-toggle="tooltip"
                                            ...
                                            <li class="mr-n1">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li>
                                                                <a href="{{route('admin.blog.edit', $blog->id)}}"><em
                                                                        class="icon ni ni-edit"></em><span>Chỉnh sửa</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="#"><em class="icon ni ni-eye"></em><span>Xem blog</span></a>
                                                            </li>
                                                            <li><a href="{{route('admin.blog.delete', $blog->id)}}"
                                                                   onclick="return confirm('Bạn có chắc chắn xóa blog này khỏi hệ thống? Lưu ý, sau khi xóa sẽ không thể khôi phục!!')">
                                                                    <em class="icon ni ni-trash"></em><span>Xóa blog</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                        ...
                        <div class="card">
                            <div class="card-inner">
                                <div class="nk-block-between-md g-3">
                                    <div class="g">
                                        {!!$blogs->onEachSide(1)->withQueryString()->links()!!}
                                    </div>
                                </div><!-- .nk-block-between -->
                            </div>
                        </div>
