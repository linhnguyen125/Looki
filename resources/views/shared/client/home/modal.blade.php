                        ...
                        <div class="product-sync-init mb-20">
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img
                                        src="{{asset('assets/client/img/slider/thumb/1.jpg')}}"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img
                                        src="{{asset('assets/client/img/slider/thumb/2.jpg')}}"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img
                                        src="{{asset('assets/client/img/slider/thumb/3.jpg')}}"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img
                                        src="{{asset('assets/client/img/slider/thumb/4.jpg')}}"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                        ...
                        <div class="product-sync-nav">
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)">
                                        <img
                                            src="{{asset('assets/client/img/slider/thumb/1.1.jpg')}}"
                                            alt="product-thumb"
                                        /></a>
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)">
                                        <img
                                            src="{{asset('assets/client/img/slider/thumb/2.1.jpg')}}"
                                            alt="product-thumb"
                                        /></a>
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"
                                    ><img
                                            src="{{asset('assets/client/img/slider/thumb/3.1.jpg')}}"
                                            alt="product-thumb"
                                        /></a>
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"
                                    ><img
                                            src="{{asset('assets/client/img/slider/thumb/4.1.jpg')}}"
                                            alt="product-thumb"
                                        /></a>
                                </div>
                            </div>
