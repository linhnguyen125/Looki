                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="html/apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                ...
                                                <div class="chat-context">
                                                    <div class="text">Have you seens the claim from Rose?
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="html/apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                ...
                                                <div class="chat-context">
                                                    <div class="text">You: I just bought a new computer but
                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="{{route('admin.user.info', Auth::guard('admin')->user()->id)}}"><em
                                                class="icon ni ni-user-alt"></em><span>Xem hồ sơ</span></a>
                                    </li>
