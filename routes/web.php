...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function(){
        ...
        Route::group(['prefix' => 'quan-tri-vien'], function (){
            ...
            Route::post('update-avatar/{id}', 'Admin\UserProfileController@updateAvatar')->name('admin.user.update_avatar');
            Route::post('update-profile/{id}', 'Admin\UserProfileController@updateProfile')->name('admin.user.update_profile');
            ...
            Route::get('hoat-dong-tai-khoan.html', 'Admin\UserProfileController@accountActivity')->name('admin.user.account_activity');
            Route::get('cai-dat-bao-mat.html', 'Admin\UserProfileController@securitySetting')->name('admin.user.security_settings');
        });
        ...
        Route::group(['prefix' => 'danh-muc'], function (){
            ...
            Route::group(['prefix' => 'tin-tuc'], function (){
                Route::get('danh-sach.html', 'Category\NewsCategoryController@index')->name('admin.category_news.index');
                Route::get('chinh-sua/{id}.html', 'Category\NewsCategoryController@edit')->name('admin.category_news.edit');
                Route::post('store', 'Category\NewsCategoryController@store')->name('admin.category_news.store');
                Route::post('update/{id}', 'Category\NewsCategoryController@update')->name('admin.category_news.update');
                Route::get('xoa/{id}', 'Category\NewsCategoryController@delete')->name('admin.category_news.delete');
            });

            //-------------------- BLOG CATEGORY ------------------------
            Route::group(['prefix' => 'blog'], function (){
                Route::get('danh-sach.html', 'Category\BlogCategoryController@index')->name('admin.category_blog.index');
                Route::get('chinh-sua/{id}.html', 'Category\BlogCategoryController@edit')->name('admin.category_blog.edit');
                Route::post('store', 'Category\BlogCategoryController@store')->name('admin.category_blog.store');
                Route::post('update/{id}', 'Category\BlogCategoryController@update')->name('admin.category_blog.update');
        ...
        Route::group(['prefix' => 'san-pham'], function (){
            ...
            Route::post('update-stock/{id}',  'Product\ProductController@updateStock')->name('admin.product.update_stock');
            Route::post('update-price/{id}',  'Product\ProductController@updatePrice')->name('admin.product.update_price');

            //---------------------- PRODUCT IMAGE ------------------------
            Route::get('them-anh-san-pham/{id}.html','ProductImage\ProductImageController@create')->name('admin.product_image.create');
            Route::post('anh-san-pham/store/{id}',  'ProductImage\ProductImageController@store')->name('admin.product_image.store');
            Route::get('xoa-anh-san-pham/{id}','ProductImage\ProductImageController@delete')->name('admin.product_image.delete');
        });
